...
if(life_markers) then {
	...
	[[0,format["ADMIN: %1 has ENABLED player markers.",name player]],"life_fnc_broadcast",true,false] spawn BIS_fnc_MP;
...
FinishedLoop = true;
	...
	[[0,format["ADMIN: %1 has DISABLED player markers.",name player]],"life_fnc_broadcast",true,false] spawn BIS_fnc_MP;
	life_adminXray = 0;
