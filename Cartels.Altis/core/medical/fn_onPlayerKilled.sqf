...
//Set some vars
_unit setVariable["Revive",TRUE,TRUE]; //Set the corpse to a revivable state.
...
_unit spawn
{
	...
	waitUntil {
		_medic="";
		_Timer ctrlSetText format["%2You will bleed to death in: %1",[(_maxTime - time),"MM:SS.MS"] call BIS_fnc_secondsToString,_medic];
